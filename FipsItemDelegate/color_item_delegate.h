...
#ifndef FIPS_COLOR_ITEM_DELEGATE_H
#define FIPS_COLOR_ITEM_DELEGATE_H
 ...
 *              true    #AARRGGBB
 */
class FIPSITEMDELEGATESHARED_EXPORT ColorItemDelegate : public QStyledItemDelegate
{
    Q_OBJECT

public:
    explicit ColorItemDelegate(QObject *parent = FIPS_NULLPTR);
    ColorItemDelegate(bool hasAlpha, QObject *parent = FIPS_NULLPTR);
    ~ColorItemDelegate();
...
#endif // FIPS_COLOR_ITEM_DELEGATE_H
