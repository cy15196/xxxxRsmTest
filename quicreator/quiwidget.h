...
class QUICREATORSHARED_EXPORT QUIWidget : public QDialog
#endif
...
//弹出信息框类
class QUICREATORSHARED_EXPORT QUIMessageBox : public QDialog
{
    Q_OBJECT
...
//弹出输入框类
class QUICREATORSHARED_EXPORT QUIInputBox : public QDialog
{
    Q_OBJECT
...
//弹出日期选择对话框
class QUICREATORSHARED_EXPORT QUIDateSelect : public QDialog
{
    Q_OBJECT
...
//图形字体处理类
class QUICREATORSHARED_EXPORT IconHelper : public QObject
{
    Q_OBJECT
...
//托盘图标类
class QUICREATORSHARED_EXPORT TrayIcon : public QObject
{
    Q_OBJECT
public:
...
//全局静态方法类
class QUICREATORSHARED_EXPORT QUIHelper : public QObject
{
    Q_OBJECT
public:
    //桌面宽度高度
    ...
    //设置按钮样式
    static void setPushButtonQss(QPushButton *btn,                             //按钮对象
                                 int radius = 5,                               //圆角半径
                                 int padding = 8,                              //间距
    ...
    //设置文本框样式
    static void setLineEditQss(QLineEdit *txt,                                 //文本框对象
                               int radius = 3,                                 //圆角半径
    ...
    //设置进度条样式
    static void setProgressBarQss(QProgressBar *bar,
    ...
    //设置滑块条样式
    static void setSliderQss(QSlider *slider,                                  //滑动条对象
