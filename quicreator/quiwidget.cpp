...
QWidget *QUIWidget::getMainWidget() const
{
...
void QUIHelper::setPushButtonQss(QPushButton *btn, int radius, int padding,
...
void QUIHelper::setLineEditQss(QLineEdit *txt, int radius, int borderWidth,
                               const QString &normalColor,
...
void QUIHelper::setProgressBarQss(QProgressBar *bar, int barHeight,
...
void QUIHelper::setSliderQss(QSlider *slider, int sliderHeight,
                             const QString &normalColor,
...
void QUIHelper::setRadioButtonQss(QRadioButton *rbtn, int indicatorRadius,
                                  const QString &normalColor,
...
void QUIHelper::setScrollBarQss(QWidget *scroll, int radius, int min, int max,
