...
#include <QLineEdit>
//自定义QListWidget
class ButtonList : public QListWidget //继承QListWidget，可以使用它本身自带的函数，更方便
{
    Q_OBJECT
public:
    ...
    void setCurrentItemHeaderPath(const QString& headerPath);
    ...
    QMap<QListWidgetItem*, int> buttonToSignalMap;


    void addGroup(const QString&groupName);
    void addItemToCurrentGroup(const QString& itemName,
