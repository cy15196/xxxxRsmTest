#ifndef RULERSLIDERGRAPHICITEM_H
#define RULERSLIDERGRAPHICITEM_H
...
#else
class TOPTESTWIDGETSSHARED_EXPORT RulerSliderGraphicItem : public QGraphicsItem
#endif
...
public:
    explicit RulerSliderGraphicItem(QGraphicsItem *parent = 0);
    QRectF RulerSliderGraphicItem::boundingRect() const
    {
        return QRectF(QPointF(-25,0),QSize(wholeSize.width()+50,wholeSize.height()));
    }
...
//    void paintEvent(QPaintEvent *);
    void drawBg(QPainter *painter, const QStyleOptionGraphicsItem *option);
    void drawRule(QPainter *painter, const QStyleOptionGraphicsItem *option);
    void drawSlider(QPainter *painter, const QStyleOptionGraphicsItem *option);
    void drawTip(QPainter *painter, const QStyleOptionGraphicsItem *option);
...
//    void valueChanged(double value);
    QSizeF getWholeSize() const;
    void setWholeSize(const QSizeF &value);
};

#endif // RULERSLIDERGRAPHICITEM_H
